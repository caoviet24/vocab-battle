...
import type { CategoryOption, HomeMode } from "@/types/type";
    ...
    <main id="main-content" className="relative min-h-screen overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <div className="hidden min-h-11 items-center gap-2 rounded-xl border border-white/10 bg-white/[0.045] px-3 text-xs text-muted backdrop-blur-md md:flex sm:px-4">
