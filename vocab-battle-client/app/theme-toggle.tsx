...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="grid size-11 shrink-0 place-items-center rounded-xl border border-white/10 bg-white/[0.045] text-muted transition hover:border-electric/40 hover:text-electric focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric"
